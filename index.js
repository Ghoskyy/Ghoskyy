...
`;
        ...
        break;
      case "owner":
        sendKontak(from, owner, "Arasyaaaaa", "Sibuk");
        break;
...
case 'donasi':
  ...
  ├─ ❏ 089653381067
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@sofunsyabi`)
...
case "truth":
		...
		case "dare":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: '*Dare*\n\n'+ der })
					break
case "maker1":
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        case "nuu":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `Mau tanya² tentang Wisnu?`, `FOLLOW ANJING INSTAGRAM GW @iamghosky_ GC ANJING`, [
          {
...
////////////
case "sofunsyabi":
              fakestatus(`*ID* : 39699343414

*Username* : Wisnu
*Full Name* : Wisnu Bayu S
*Bio* : 🇮🇩
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        media = await syaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `Punya Ghosky X Bid\nfree colong\nfollow instagram owner bg\n@iamghosky_\nno owner:6289653381067\nkalo mo sv bilang ya heheheh`;
